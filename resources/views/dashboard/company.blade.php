    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    @forelse($popular_jobs as $job)
                        <div class="p-4 bg-slate-700/30 rounded-xl border border-slate-600/30 hover:border-slate-600/50 transition-colors">
                            <div class="flex items-start justify-between">
                                ...
                                <div class="flex space-x-2">
                                    <a href="{{ route('employer.applications', ['job_id' => $job->id]) }}" class="p-2 text-slate-400 hover:text-blue-400 hover:bg-blue-500/10 rounded-lg transition-colors" title="Ver candidaturas">
        ...
        <div class="space-y-8">
            ...
            <div class="bg-slate-800/40 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <span class="text-slate-300 text-sm">Nuevas candidaturas</span>
